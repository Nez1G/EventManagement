    ...
    border-top: none;
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <br>
                <div class="tab">
                    <button class="tablinks" id="botaoEvento" onclick="openCity(event, 'CriarEvento')">Criar Evento</button>
                ...
                <div class="row">
                    <div class="panel-body">
                        <form role="form" name="formEvento">
                            ...
                            <input type="hidden" id="apoioCamara"/>
                            ...
                            <fieldset> 
                                <legend>Informação Evento</legend>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea placeholder="Por favor, insira uma descrição do Evento" class="form-control" rows="3" id="descricao" disabled></textarea>
                                    </div>
                            </fieldset> 
                         </form>
...
<div id="Servico" class="tabcontent">
  ...
  <button type="button" id="cancelar" class="btn btn-primary">Voltar</button>
  <button type="button" class="btn btn-danger" id="rejeitarEvento" onclick="validarEvento()">Rejeitar</button>
  <button type="button" class="btn btn-success" id="aprovarEvento" onclick="validarEvento()">Aprovar</button>
</div>
...
function (data) {
    for (var i = 0; i < data.length; i++) {
       ...
       document.getElementById("tipoEvento").value= data[i].tipoEvento;
    }
});
...
//                  });
                   ...
                   $.ajax({
                        url: "/daihugo/webresources/Evento/mudarEstado/".concat($('#idEvento').val(),'/',"2"),
                        method: "POST",
                        data: "",
                        dataType: 'json',
                         ...
                         error: function(jqXHR, textStatus, errorThrown){
                             alert("Não foi possível rejeitar o evento!");
...
//                  });
                   ...
                   $.ajax({
                        url: "/daihugo/webresources/Evento/mudarEstado/".concat($('#idEvento').val(),'/',"1"),
                        method: "POST",
                        data: "",
                        dataType: 'json',
                         success: function(data,status,jqXHR){
                         ...
                         error: function(jqXHR, textStatus, errorThrown){
                              alert("Não foi possível aprovar o evento!");
                              console.log(errorThrown);
                         }
                    });
